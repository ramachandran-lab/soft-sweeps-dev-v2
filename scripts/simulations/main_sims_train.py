...
# Main script for generating simulated training dataset  #
#--------------------------------------------------------#
#!/usr/bin/env python
...
if __name__ == '__main__':
    ...
    params_sims.chromosome_length = params_sims.chromosome_length_train
    params_sims.window_step_size_sim = params_sims.window_step_size_train
    label = 'NA'
    job = 'NA'
    seed = 'NA'
    if len(sys.argv) >= 2:
